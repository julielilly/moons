...
const HeaderMenu = ({
  ...
  return (
    <div
      className={`bg-grey fixed right-0 top-0 flex h-[100svh] min-h-full w-[90vw] min-w-[400px] flex-col transition-transform duration-300 ease-out ${menuOpen ? "translate-x-0" : "translate-x-full"}`}
    >
