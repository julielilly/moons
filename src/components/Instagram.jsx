...
const Instagram = () => {
  useEffect(() => {
    ...
    script.type = "module"; // required for the behold widget
    script.src = "https://w.behold.so/widget.js"; // link to the behold widget script

    // add the script tag to the head of the page
    document.head.appendChild(script);

    return () => {
      document.head.removeChild(script); // remove the script when the component is unmounted (cleanup)
    };
  }, []); // only run this once when the component mounts

  return (
    <section className="bg-grey pb-2xl mb-0">
      ...
      <p className="h2 mt-m text-center md:mt-0">Moons på Instagram</p>

      <div className="my-s">
        <behold-widget feed-id="dIjBPP5gmZOtuy5G976F" />
      </div>

      <a
        target="blank"
        href="https://www.instagram.com/moons._____/"
        className="button flex-center gap-2xs group mx-auto w-fit"
      >
        <svg
          width="20"
          height="20"
        ...
        >
          <g clipPath="url(#clip0_98_1002)">
            <path
              ...
              className="fill-background group-hover:fill-dark-green transition-all"
            />
            <path
